...
A diferencia del PIB, el PMI se publica mensualmente y con muy poco retraso. Los directores de compras son los primeros en notar cambios en la demanda, ya que hacen los pedidos antes de que las ventas se materialicen. Por eso el PMI anticipa lo que el PIB confirmará meses después.
...
La curva de tipos (yield curve) representa la relación entre la rentabilidad de los bonos del gobierno y su plazo de vencimiento. Normalmente, los bonos a más largo plazo pagan más que los de corto plazo, lo que tiene sentido porque prestas el dinero más tiempo.
...
Además de los tipos, los bancos centrales usan otra herramienta clave: el [QE y el QT](/blog/qe-qt-cuando-invertir/), que amplifica o atenúa estos movimientos de la curva.
