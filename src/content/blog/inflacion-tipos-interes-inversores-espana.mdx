...
Una inflación moderada del 2% se considera saludable, ya que indica que la economía crece. El problema es cuando se dispara por encima del 5-6%, como ocurrió en España en 2022.
...
Una de esas herramientas, junto a los tipos de interés, es el [QE y el QT](/blog/qe-qt-cuando-invertir/): la expansión o contracción del balance del banco central.
...
¿Por qué? Si tienes un bono que paga el 2% y de repente los nuevos bonos pagan el 4%, tu bono del 2% vale menos, ya que nadie lo quiere al mismo precio si puede comprar uno nuevo que paga más.
