...
A diferencia del [análisis técnico](/blog/analisis-tecnico-que-es-para-que-sirve/), que intenta anticipar movimientos del mercado, la inversión pasiva no predice nada: simplemente replica el índice.
...
Si no tienes claro las diferencias entre [fondos indexados y ETFs](/blog/fondos-indexados-vs-etfs-diferencias/) para el inversor español, te lo explico en esta comparativa completa.
...
Para saber qué [broker para invertir](/blog/mejores-brokers-invertir-espana/) te conviene, aquí tienes la comparativa completa de mejores brokers en España.
