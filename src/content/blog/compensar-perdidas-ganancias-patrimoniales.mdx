...
- Vende el ETF del MSCI World y compra un ETF del MSCI ACWI (no es el mismo activo, aunque sea similar).
...
- Si operas con varios brokers o exchanges, considera usar una herramienta de tracking fiscal como CoinTracking (para cripto) o una hoja de cálculo propia.
