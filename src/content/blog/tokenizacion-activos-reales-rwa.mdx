...
**RealT**: plataforma americana de inmobiliario tokenizado. Compras tokens que representan fracciones de propiedades residenciales en EE.UU. y recibes el alquiler semanalmente en [stablecoins](/blog/stablecoins-que-son-como-usarlas/).

**Propiedades en Europa**: están surgiendo plataformas similares en Europa, aunque la regulación es más compleja.

La ventaja frente a los [REITs y SOCIMIs](/blog/invertir-inmobiliario-reits-socimis/): exposición directa a propiedades específicas con rentas más predecibles. La desventaja: menor liquidez y mayor riesgo de concentración.
