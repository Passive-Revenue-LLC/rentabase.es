...
Los tipos de interés del BCE llevan subiendo desde 2022, con una nueva subida en junio de 2026 que ha llevado los tipos a su nivel más alto desde 2008. Para el ahorrador, esto tiene una consecuencia directa: las cuentas remuneradas y los depósitos vuelven a tener sentido como destino para tu liquidez.

No hablamos de hacerte rico con los intereses, pero sí de que tu fondo de emergencia no pierda valor frente a la inflación. Con tasas actuales por encima del 2%, dejar el dinero en cuenta corriente es directamente regalar rentabilidad.
...
### Tasas actuales (julio 2026)

| Entidad | TAE aproximada | Requisitos | Liquidez | FGD |
|---|---|---|---|---|
| Trade Republic | 3,04% | Ninguno | Inmediata | Alemán (€100k) |
| MyInvestor | 2,50% | Ninguno | Inmediata | Español (€100k) |
| Raisin (mejor depósito 12m) | 3,05% | 12 meses | Al vencimiento | Varía por banco (€100k) |
| Letras del Tesoro 12m | 2,50% | 12 meses | Mercado secundario | Estado español |

*Tasas orientativas, sujetas a cambio. Verifica en la web de cada entidad antes de contratar.*
