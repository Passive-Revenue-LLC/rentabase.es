...
Si te interesa el [análisis técnico](/blog/analisis-tecnico-que-es-para-que-sirve/), la mayoría de brokers de esta lista tienen gráficos integrados con los indicadores más habituales (medias móviles, RSI, MACD), así que no necesitas una herramienta externa para empezar a mirarlos.
...
Si [estás empezando](/blog/como-empezar-a-invertir-desde-cero/) y quieres la opción más sencilla para inversión pasiva a largo plazo, Myinvestor para fondos indexados o Trade Republic para planes de ETFs son las opciones que recomendaría.
...
Elegir el broker es solo el primer paso. El siguiente es decidir [cómo construir una cartera](/blog/diversificacion-como-construir-cartera-equilibrada/) bien diversificada con los productos que ese broker te ofrece.
